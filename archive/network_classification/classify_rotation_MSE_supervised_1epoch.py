...
BASE_DIR = "tmp_supervised_1epoch"
os.makedirs(BASE_DIR, exist_ok=True)

OUTPUT_DIR = "output_supervised_1epoch"
...
if __name__ == "__main__":
    ...
    UNSUPERVISED = False  # Set to True for unsupervised learning, False for supervised learning
    ROTATION_DEGS = 0.5
    NUM_ITERATIONS = 720
    NUM_EPOCHS = 1
    PLOT_EVERY = 10
