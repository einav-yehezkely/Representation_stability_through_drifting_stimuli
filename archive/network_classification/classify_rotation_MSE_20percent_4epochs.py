...
BASE_DIR = "tmp_20percent_4epochs"
os.makedirs(BASE_DIR, exist_ok=True)

OUTPUT_DIR = "output_20percent_4epochs"
os.makedirs(OUTPUT_DIR, exist_ok=True)

PCA_DF = pd.read_csv("pca_top2_filtered_female_20_percent.csv", header=None)
...
if __name__ == "__main__":
    ...
    names, points = load_top2_filtered("pca_top2_filtered_female_20_percent.csv")
    base_point, opposite_point = create_base_and_opposite_points(0, csv_path="pca_top2_filtered_female_20_percent.csv")
    self_training_model = load_model(model_path="model_ft_0_MSE_20_percent.pth")
