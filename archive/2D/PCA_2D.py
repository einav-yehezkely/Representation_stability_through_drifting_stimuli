#################################################################
# Representation of the face in 2 dimensions using PCA on 512 dimensions vectors
# 2D representation of the face using PCA on 512 dimensions vectors
# 18/05/2025
#################################################################
import pandas as pd
import numpy as np
...
# This reduces the dimensionality of the original 512D vectors to 2D in order to observe similar photos
X_projected = project_data(X_prepared, sorted_eigenvectors, 2)
...
df_projected.to_csv("pca_2D_24.csv", index=False)
print("Saved PCA-reduced embeddings to pca_2D_faces.csv")
...
eigenvalues_df.to_csv("pca_2D_eigenvalues.csv", index=False)
