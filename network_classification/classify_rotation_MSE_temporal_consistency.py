...
from shufflenet_v2_x0_5_MSE_temporal_consistency import (
    train_model,
    get_dataloaders,
...
BASE_DIR = "tmp_temp_consistency"
os.makedirs(BASE_DIR, exist_ok=True)

OUTPUT_DIR = "output_temp_consistency"
...
if __name__ == "__main__":
    ...
    for i in range(
        ...
        if UNSUPERVISED:
            ...
            current_probs = {
                rec["filename"]: 1 - rec["prob_A"]  # convert prob_A to prob_B
